...
//load "We are Envoy tweets"
$('.redbox').click(function() {
  console.log('clicked')
  if ($('.redbox').hasClass('activetweetsbox')) {
    return $('.redbox').removeClass('activetweetsbox')
  }
  $('.redbox').addClass('activetweetsbox');
